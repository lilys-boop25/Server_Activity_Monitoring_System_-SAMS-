...
public class ServicesPanel extends OshiJPanel {
    ...
    private void init(SystemInfo si){
        ...
        serLabel.setFont(new Font("Segoe UI", Font.BOLD, 20));
        serLabel.setOpaque(true);
        serLabel.setBackground(new Color(255, 140, 0)); // DarkOrange
        serLabel.setForeground(Color.WHITE);
        serLabel.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));
